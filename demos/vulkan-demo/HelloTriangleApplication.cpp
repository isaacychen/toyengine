...
//    }
    ...
    void HelloTriangleApplication::pickPhysicalDevice() {
        ...
        auto matchedDevices =
                devices | std::views::filter([this](const VkPhysicalDevice &device) {
                    return isDeviceSuitable(device);
                });

        std::cout << "Matched devices:\n";
        ...
        physicalDevice = matchedDevices.front();
    }
...
//                           deviceFeatures.geometryShader;
    ...
    void HelloTriangleApplication::createSwapChain() {
        ...
        if (indices.graphicsFamily != indices.presentFamily) {
            ...
            // then we either have to explicitly transfer ownership of images between
            ...
            // If the graphics and present queues are from the same queue family,
            // then there is no need for explicit ownership transfers
